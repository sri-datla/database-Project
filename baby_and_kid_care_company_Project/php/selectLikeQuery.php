...
<body>
    ...
    try {
        $sql = "SELECT SSN, FULL_NAME, DATE_OF_BIRTH, NATIONALITY, GENDER, AVAILABLE_DAY_OF_WEEK, AVAILABLE_START_TIME, 
        AVAILABLE_END_TIME, OTHER_OCCUPATION, HIGHEST_EDUCATION_DEGREE, HOURLY_PAY_RATE, BRANCH_ID 
        FROM BABY_SITTER WHERE FULL_NAME LIKE '$_POST[bname]%'";
