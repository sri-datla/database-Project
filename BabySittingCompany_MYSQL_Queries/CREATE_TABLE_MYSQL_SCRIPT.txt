...
-- IF NOT EXSISTS COMMAND WORK HERE ON MYSQL BUT DOES NOT WORK ON MSSQL
CREATE DATABASE IF NOT EXISTS baby_and_kid_care_company;
...
CREATE TABLE IF NOT EXISTS BABY_SITTER (
SSN INT, 
...
CREATE TABLE IF NOT EXISTS BABY_SITTER_LANGUAGE (
SSN INT,
...
CREATE TABLE IF NOT EXISTS BABY_SITTER_SKILL (
SSN INT,
SKILL VARCHAR(255),
...
CREATE TABLE IF NOT EXISTS FAMILY_EMAIL (
FAMILY_ID INT,
EMAIL VARCHAR(255),
...
CREATE TABLE IF NOT EXISTS FAMILY_MOBILE_NUMBER (
FAMILY_ID INT,
...
CREATE TABLE IF NOT EXISTS CHILD_LANGUAGES_SPOKEN(
FAMILY_ID INT,
CHILD_ID INT,
LANGUAGE_SPOKEN VARCHAR(50),
